...
-- Dumping data for table abandoned_explorer.group_members: ~2 rows (approximately)
...
-- Dumping data for table abandoned_explorer.group_messages: ~7 rows (approximately)
...
-- Dumping data for table abandoned_explorer.location_visits: ~69 rows (approximately)
...
-- Dumping data for table abandoned_explorer.user_locations: ~95 rows (approximately)
